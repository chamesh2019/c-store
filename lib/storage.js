                        ...
                        if (error) {
                            ...
                            rows.forEach(row => {
                                try {
                                    ...
                                    console.warn(`Failed to parse JSON for key ${row.key}: ${parseError.message}`); // Log parsing error
                                }
                            });
                            resolve(result);
                        }
                    ...
                    (error, row) => {
                        if (error) {
                            ...
                            try {
                                ...
                                resolve(row.value);
                                console.warn(`Failed to parse JSON for key ${key}: ${parseError.message}`); // Log parsing error
                            }
                        }
                    }
                );
